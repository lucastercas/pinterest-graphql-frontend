      ...
      <div className="add-pin">
        ...
        <form onSubmit={this.addPin}>
          ...
          <input type="url" value={this.state.link} 
            onChange = {
              evt =>  this.setState({link: evt.target.value})
            }
            required />
          <input type="url" value={this.state.image} 
            onChange = {
              evt =>  this.setState({image: evt.target.value})
            }
            required />
          <button>Save</button>
        </form>
  ...
  return (
    <Route
      ...
      component={routerProps => (
        <AddPin {...routerProps} {...props} addPin={addPin} />
      )}
    />
  );
};
